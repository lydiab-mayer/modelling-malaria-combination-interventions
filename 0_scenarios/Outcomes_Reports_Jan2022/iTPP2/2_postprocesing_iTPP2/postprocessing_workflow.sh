...
#SBATCH -e /scicore/home/penny/malinga/M3TPP/Experiments/JOB_OUT/postprocessing_jobs.err
#SBATCH -o /scicore/home/penny/malinga/M3TPP/Experiments/JOB_OUT/postprocessing_jobs.out
#SBATCH --mem=10G
#SBATCH --qos=1day
...
NUM=${#split_files[@]}
sbatch -W --array=1-$NUM job_postprocessing.sh $SPLIT_FOLDER $OM_FOLDER $OUTPUT_FOLDER $DOSE_TIME
