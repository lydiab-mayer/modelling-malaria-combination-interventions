...
experiments <- c("Obj6_Scen1_PreErythProfiles", "Obj6_Scen1_LayerCounterfactual_PreErythProfiles")
...
for (index in 1:2) {
  param_label[[index]] <- paste0("Perfect deployment scenario | ",
...
saveRDS(dfOut, "./data_and_figures/supplement_fig21/data_fig21.rds")
saveRDS(dfOutAggregate, "./data_and_figures/supplement_fig21/data_aggregate_fig21.rds")
saveRDS(param_label, "./data_and_figures/supplement_fig21/label_fig21.rds")
