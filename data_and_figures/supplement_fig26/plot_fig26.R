...
# Load data
data <- readRDS("/scicore/home/penny/brauna0000/M3TPP/data_and_figures/supplement_fig26/data_fig26.rds")

# Load tag
tag <- readRDS("/scicore/home/penny/brauna0000/M3TPP/data_and_figures/supplement_fig26/label_fig26.rds")
tag
...
ggsave(filename = "/scicore/home/penny/brauna0000/M3TPP/data_and_figures/supplement_fig26/plot_fig26.jpeg",
       plot = last_plot(),
       width = 8,
       height = 4.5,
       dpi = 400)
