...
# Load data
data <- readRDS("/scicore/home/penny/brauna0000/M3TPP/data_and_figures/supplement_fig27B/data_fig27.rds")

# Load tag
tag <- readRDS("/scicore/home/penny/brauna0000/M3TPP/data_and_figures/supplement_fig27B/label_fig27.rds")
tag
...
p1 <- p + q + r +
  ...
  plot_annotation(title = "A. Blood stage parameter relationships with cumulative case outcomes by five years old, perfect deployment scenario") &
...
p2 <- p + q + r +
  plot_layout(guides = "collect") +
  plot_annotation(title = "B. Blood stage parameter relationships with cumulative case outcomes by ten years old, perfect deployment scenario") &
...
ggsave(filename = "/scicore/home/penny/brauna0000/M3TPP/data_and_figures/supplement_fig27B/plot_fig27.jpeg",
       plot = last_plot(),
       width = 9,
       height = 6.5,
       dpi = 400)
