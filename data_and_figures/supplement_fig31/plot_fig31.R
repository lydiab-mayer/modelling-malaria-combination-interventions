...
# Load data
data <- readRDS("./data_and_figures/supplement_fig31/data_fig31.rds")

# Load tag
tag <- readRDS("./data_and_figures/supplement_fig31/label_fig31.rds")
tag
...
ggsave(filename = "./data_and_figures/supplement_fig31/fig31.jpeg",
       plot = last_plot(),
       width = 9,
       height = 6.5,
       dpi = 400)
