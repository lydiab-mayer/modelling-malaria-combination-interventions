...
# Load data
data <- readRDS("/scicore/home/penny/brauna0000/M3TPP/data_and_figures/supplement_fig29/data_fig29.rds")
...
ggsave(filename = "/scicore/home/penny/brauna0000/M3TPP/data_and_figures/supplement_fig29/plot_fig29.jpeg",
       plot = last_plot(),
       width = 8,
       height = 5,
       dpi = 400)
