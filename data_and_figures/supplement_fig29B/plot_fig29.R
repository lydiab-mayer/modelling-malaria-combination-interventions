...
# Load data
data <- readRDS("/scicore/home/penny/brauna0000/M3TPP/data_and_figures/supplement_fig29B/data_fig29.rds")

# Load tag
tag <- readRDS("/scicore/home/penny/brauna0000/M3TPP/data_and_figures/supplement_fig29B/label_fig29.rds")
tag
...
p1 <- p + q + r + s +
  ...
  plot_annotation(title = "A. Blood stage parameter relationships with cumulative case outcomes by five years old, random allocation scenario") &
...
p2 <- p + q + r + s +
  plot_layout(guides = "collect", nrow = 1) +
  plot_annotation(title = "B. Blood stage parameter relationships with cumulative case outcomes by ten years old, random allocation scenario") &
...
ggsave(filename = "/scicore/home/penny/brauna0000/M3TPP/data_and_figures/supplement_fig29B/plot_fig29.jpeg",
       plot = last_plot(),
       width = 8.5,
       height = 6.5,
       dpi = 400)
