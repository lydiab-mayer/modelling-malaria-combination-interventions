...
experiments <- c("Obj6_Scen3_PreErythProfiles", "Obj6_Scen3_LayerCounterfactual_PreErythProfiles")
...
saveRDS(dfOut, "./data_and_figures/manuscript_fig2/data_fig2.rds")
saveRDS(dfOutAggregate, "./data_and_figures/manuscript_fig2/data_aggregate_fig2.rds")
saveRDS(param_label, "./data_and_figures/manuscript_fig2/label_fig2.rds")
