...
# Load data
data <- readRDS("/scicore/home/penny/brauna0000/M3TPP/data_and_figures/supplement_fig28/data_fig28.rds")
...
ggsave(filename = "/scicore/home/penny/brauna0000/M3TPP/data_and_figures/supplement_fig28/plot_fig28.jpeg",
       plot = last_plot(),
       width = 8,
       height = 5,
       dpi = 400)
