...
experiments <- c("Obj6_v2_PreEryth", "Obj6_Scen1_BloodStage", "Obj6_Scen1_PreEryth_BloodStage")
...
data <- data %>%
  mutate(Seasonality = case_match(Seasonality,
         ...
         Experiment = case_match(Experiment,
                                 "Obj6v2PreEryth" ~ "Pre-erythrocytic activity alone",
                                 "Obj6Scen1BloodStage" ~ "Blood stage activity alone",
                                 "Obj6Scen1PreErythBloodStage" ~ "Pre-erythrocytic and blood stage activity"),
...
data$AnnualPrev[data$AnnualPrev == "33%"] <- "32%"
data$AnnualPrev[data$AnnualPrev == "55%"] <- "56%"
data$AnnualPrev[data$AnnualPrev == "63%"] <- "64%"
...
saveRDS(data, "/scicore/home/penny/brauna0000/M3TPP/data_and_figures/supplement_fig28/data_fig28.rds")
