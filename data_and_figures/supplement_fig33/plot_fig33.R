...
# Load data
data <- readRDS("./data_and_figures/supplement_fig33/data_fig33.rds")

# Load tag
tag <- readRDS("./data_and_figures/supplement_fig33/label_fig33.rds")
tag
...
ggsave(filename = "./data_and_figures/supplement_fig33/fig33.jpeg",
       plot = last_plot(),
       width = 8.5,
       height = 6.5,
       dpi = 400)
