...
# intervention_year = as.integer(args[6])
...
# print(paste("Intervention year:", intervention_year))

# Postprocess the OpenMalaria simulations
cat("Run OM postprocessing function:")
postprocess_OM_baseline(results_folder = om_results_folder, param_table_file = split_file,
