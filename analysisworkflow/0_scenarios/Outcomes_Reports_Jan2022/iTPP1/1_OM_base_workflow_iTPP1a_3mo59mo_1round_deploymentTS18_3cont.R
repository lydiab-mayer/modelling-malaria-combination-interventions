...
exp ="iTPP1a_3mo59mo_1round_deploymentTS18_3cont"
...
# EIR_ref = EIR_ref[complete_cases(EIR_ref),]
# 
# # Unique EIR
...
# prev_ref_sub_seas3 = prev_ref_sub %>% filter(Seasonality == "seas3mo")
# table(prev_ref_sub_seas3$access, prev_ref_sub_seas3$prev_210_cat)
# prev_ref_sub_seas4 = prev_ref_sub %>% filter(Seasonality == "seas4mo")
# table(prev_ref_sub_seas4$access, prev_ref_sub_seas4$prev_210_cat, prev_ref_sub_seas4$EIR)
# table(prev_ref_sub_seas4$access, prev_ref_sub_seas4$prev_210_cat)
# prev_ref_sub_seas5 = prev_ref_sub %>% filter(Seasonality == "seas5mo")
# table(prev_ref_sub_seas5$access, prev_ref_sub_seas5$prev_210_cat)
# prev_ref_sub_seas6 = prev_ref_sub %>% filter(Seasonality == "seas6mo")
# table(prev_ref_sub_seas6$access, prev_ref_sub_seas6$prev_210_cat)
# prev_ref_sub_seas9 = prev_ref_sub %>% filter(Seasonality == "seas9mo")
# table(prev_ref_sub_seas9$access, prev_ref_sub_seas9$prev_210_cat)
